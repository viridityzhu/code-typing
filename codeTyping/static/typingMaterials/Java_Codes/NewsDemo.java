	...
	public static void main(String[] args) {
		...
		bbc.addListener(new Listener () {
			public void newsArrived(NewsEvent e){
				if( e.level>6) System.out.println("Notice :");
				System.out.println("now," + e.text + " happened!");
			}
		});
		//2.Lambda实现：
		bbc.addListener((NewsEvent e)-> System.out.println("You have to know this: "+e.text));
