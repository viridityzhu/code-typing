...
int main() {
    ...
    if ((a - (int)(a)) != 0) {
        if (a > 0) {
            ...
            imptdoublecountera = tonegdoublebinary(a);
        }
        if (b > 0) {
            imptdoublecounterb = todoublebinary(b);
        } else {
            imptdoublecounterb = tonegdoublebinary(b);
        }
        ...
        if (a > 0) {
            imptintcountera = tointbinary(a);
        } else {
            imptintcountera = tonegintbinary(a);
        }
        if (b > 0) {
            imptintcounterb = tointbinary(b);
        } else {
            imptintcounterb = tonegintbinary(b);
        }
